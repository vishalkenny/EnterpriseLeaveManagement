...
namespace EnterpriseLeaveManagement.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveRequestLeaveId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveStatusHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeaveStatusHistories_LeaveRequests_LeaveRequestLeaveId",
                        column: x => x.LeaveRequestLeaveId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveStatusHistories_LeaveRequestLeaveId",
                table: "LeaveStatusHistories",
                column: "LeaveRequestLeaveId");
        }
